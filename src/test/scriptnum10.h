...
#ifndef CIVILBIT_TEST_SCRIPTNUM10_H
#define CIVILBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Civilbit Core 0.10.0, for cross-comparison.
 */
public:
