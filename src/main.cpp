...
#if defined(NDEBUG)
# error "Civilbit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Civilbit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s MBT additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("civilbit-scriptch");
