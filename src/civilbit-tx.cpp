...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Civilbit Core civilbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  civilbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded civilbit transaction") + "\n" +
              "  civilbit-tx [options] -create [commands]   " + _("Create hex-encoded civilbit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded civilbit transaction
