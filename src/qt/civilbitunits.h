...
#ifndef CIVILBIT_QT_CIVILBITUNITS_H
#define CIVILBIT_QT_CIVILBITUNITS_H
...
/** Civilbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CivilbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CivilbitUnits(QObject *parent);

    /** Civilbit units.
      @note Source: https://en.civilbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MBT,
...
private:
    QList<CivilbitUnits::Unit> unitlist;
};
typedef CivilbitUnits::Unit CivilbitUnit;

#endif // CIVILBIT_QT_CIVILBITUNITS_H
