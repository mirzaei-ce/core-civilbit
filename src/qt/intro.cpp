...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/civilbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Civilbit Core"),
     ...
     * override -datadir in the civilbit.conf file in the default data directory
     * (to be consistent with civilbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
