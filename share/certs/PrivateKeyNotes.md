...
unlocked to sign the Civilbit-Qt.app bundle.
...
allowing somebody to distribute a Civilbit-Qt.app or civilbit-qt-setup.exe with a valid
...
that the civilbit-qt.exe file inside the installer had not been tampered with.
