Download URL: https://sourceforge.net/projects/civilbit/files/Civilbit/civilbit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MBT fee schedule (users still pay 0.01 MBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #civilbit00 - #civilbit99
