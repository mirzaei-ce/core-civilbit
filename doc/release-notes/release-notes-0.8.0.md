Civilbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/civilbit/files/Civilbit/civilbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Civilbit
...
New/changed settings (command-line or civilbit.conf file)
--------------------------------------------------------
