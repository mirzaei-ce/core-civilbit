Civilbit Core version 0.9.4 is now available from:

  https://civilbit.org/bin/0.9.4/
...
this update is incompatible with the Civilbit system and could lead to consensus
forks.

Civilbit Core released binaries from https://civilbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~civilbit/+archive/ubuntu/civilbit
- A third-party or self-compiled Civilbit Core

upgrade to Civilbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
