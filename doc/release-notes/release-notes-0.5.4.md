Civilbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/civilbit/files/Civilbit/civilbit-0.5.4/
...
http://gitorious.org/civilbit/civilbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Civilbit-Qt notifications under Growl 1.3.
Increase required age of Civilbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCivilbit properly when installing Civilbit-Qt over it. (Windows)
