...
This document provides guidelines for internationalization of the Civilbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `civilbit_en.ts` remains unchanged.
